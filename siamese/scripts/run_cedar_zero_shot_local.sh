...
# Reuse the portable defaults already built into the Python entry point while
# still allowing one-command overrides from the shell when needed.
...
python -m signature_siamese.evaluate_cedar_zero_shot
